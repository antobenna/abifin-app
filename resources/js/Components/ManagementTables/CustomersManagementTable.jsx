                ...
                <TableRow key={c.id}>
                    ...
                    <TableCell>
                        <div className="flex items-center gap-1">
                            <Link href={route('customers.show', c.id)} className="p-2 text-default-400 hover:text-primary transition-colors rounded" title="Visualizza">
                            ...
                            {isAdmin && (
                                <>
                                    <Link href={route('customers.edit', c.id)} className="p-2 text-default-400 hover:text-primary transition-colors rounded" title="Modifica">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                        </svg>
                                    </Link>
                                    <button onClick={() => onDelete(c)} className="p-2 text-default-400 hover:text-danger transition-colors rounded" title="Elimina">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">

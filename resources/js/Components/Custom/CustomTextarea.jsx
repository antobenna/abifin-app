    ...
    return (
        <div>
            ...
            <textarea
                ...
                rows={rows}
                className={`w-full px-4 py-3 rounded-md border text-gray-900 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 outline-none transition-all resize-none
